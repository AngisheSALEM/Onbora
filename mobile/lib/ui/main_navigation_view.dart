  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color(0xFF4F6CE8),
        ...
        child: Column(
          children: [
            ...
            const CircleAvatar(
              ...
              child: Icon(Icons.person_rounded, size: 48, color: Color(0xFF4F6CE8)),
            ),
            ...
            Container(
              ...
              child: Text(
                ...
                style: const TextStyle(color: Color(0xFF4F6CE8), fontWeight: FontWeight.bold, fontSize: 12),
              ),
            ),

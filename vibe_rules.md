...
## Règle 6 : Tests Unitaires et Spécifications de Test
*   Chaque fonctionnalité majeure doit être testée (unitaires et intégration).
*   Un plan de test répertoriant les éléments à valider doit être défini dans [unit_tests_plan.md](file:///C:/Users/Salem/Documents/projet/Onbora/unit_tests_plan.md).
*   Les tests unitaires écrits doivent être exécutés et passer avec succès avant de considérer une étape comme terminée.

## Règle 8 : Utilisation du Skill UX lors des refontes et designs UI
Dès qu'une tâche implique une **refonte d'interface**, une **création ou modification de composant UI**, ou du travail sur le style (CSS, Tailwind, accessibilité) :
*   L'assistant et tout sous-agent doivent obligatoirement charger et appliquer les directives du skill [ux-ui-design-frontend](file:///C:/Users/Salem/.gemini/config/plugins/salem/skills/ux-ui-design-frontend/SKILL.md) avant d'écrire ou de modifier du code d'interface.

## Règle 9 : Cadre d'Intégration du Scraping
Pour toute tâche liée à l'implémentation, la modification ou l'intégration du module de scraping automatisé d'Onbora, l'assistant et les sous-agents doivent obligatoirement suivre les étapes définies dans le fichier de spécification :
*   [etapes_scraping.md](file:///C:/Users/Salem/Documents/projet/Onbora/etapes_scraping.md)

## Règle 10 : Push Git Obligatoire après chaque Changement

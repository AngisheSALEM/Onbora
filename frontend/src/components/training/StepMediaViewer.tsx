            ...
            <div className="w-[140px] h-[220px] rounded-2xl border-4 border-zinc-800 bg-zinc-900 shadow-2xl relative flex flex-col items-center overflow-hidden">
              ...
              <div className="flex-1 w-full pt-6 px-2 flex flex-col items-center text-center justify-between pb-3">
                <div className="flex flex-col items-center gap-1.5 mt-2">
                  ...
                  <span className="text-[9px] font-semibold text-zinc-200">Authenticator</span>
                </div>

                {currentStep === 1 && (
                  <div className="flex-1 flex flex-col items-center justify-center gap-1.5">
                    <div className="px-3 py-1.5 rounded bg-blue-650 text-[8px] font-semibold text-white uppercase tracking-wider animate-bounce">
                      Télécharger App
                    </div>
                ...
                {currentStep >= 3 && (
                  <div className="flex-1 flex flex-col items-center justify-center gap-2 w-full px-1">
                    <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-1.5 w-full flex flex-col gap-1">
                      <span className="text-[7px] font-semibold text-zinc-300">Connexion professionnelle</span>
                      <span className="text-[9px] font-extrabold text-blue-600 dark:text-blue-400 tracking-widest animate-pulse">48</span>
                      <span className="text-[6px] text-zinc-500">Entrez ce nombre pour valider</span>
                    </div>
                    
                    <div className="flex gap-1.5 w-full justify-center">
                      <span className="px-2 py-0.5 rounded bg-zinc-700 text-[7px] font-semibold text-zinc-400">Refuser</span>
                      <span className={`px-2 py-0.5 rounded bg-green-500 text-[7px] font-semibold text-white ${pulse ? 'ring-2 ring-green-400' : ''}`}>Approuver</span>
                    </div>
                  </div>
                )}
          ...
          <div className="w-full h-full flex flex-col items-center justify-center p-4 bg-zinc-900 rounded-2xl relative overflow-hidden border border-zinc-800">
            ...
            <div className="w-[180px] bg-zinc-950 rounded-lg border border-zinc-800 shadow-2xl overflow-hidden flex flex-col text-left">
              ...
              <div className="bg-zinc-900 px-2.5 py-1.5 flex items-center justify-between border-b border-zinc-800">
                <span className="text-[8px] font-semibold text-zinc-400 flex items-center gap-1.5">
              ...
              <div className="p-3 flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  <span className="text-[7px] text-zinc-500 uppercase font-semibold tracking-wider">Serveur VPN</span>
                ...
                <div className="flex items-center justify-between mt-1">
                  <span className="text-[7px] text-zinc-500 font-semibold flex items-center gap-1">
                    Status: 
                    {currentStep >= 4 ? (
                  ...
                  <button className={`px-3 py-1 rounded text-[8px] font-semibold text-white transition-all shadow-sm ${
                    currentStep >= 4 
        ...
        return (
          <div className="w-full h-full flex flex-col justify-between p-3.5 bg-zinc-900 rounded-2xl border border-zinc-800 text-left text-[8px]">
            ...
            <div className="flex items-center justify-between border-b border-zinc-800 pb-2 mb-2">
              ...
              {currentStep === 2 && (
                <span className="px-2 py-0.5 rounded bg-blue-600 font-semibold text-white animate-pulse flex items-center gap-1 cursor-pointer">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              <div className="flex items-center justify-between p-1.5 bg-zinc-950/40 rounded border border-zinc-850/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-zinc-300 font-semibold">Dossier Direction Générale</span>
                </div>
                {currentStep >= 2 ? (
              ...
              <div className="flex items-center justify-between p-1.5 bg-zinc-950/40 rounded border border-zinc-850/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-zinc-300 font-semibold">Budget_Projets_2026.xlsx</span>
                </div>
                {currentStep >= 2 ? (
              ...
              <div className="flex items-center justify-between p-1.5 bg-zinc-950/40 rounded border border-zinc-850/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-zinc-300 font-semibold">Roadmap_Onboarding_Client.pdf</span>
                </div>
                {currentStep >= 3 ? (
                  <div className="flex items-center gap-1.5">
                    <span className="text-[7px] text-green-500 font-550">Lien partagé</span>
            ...
            <div className="flex-1 flex flex-col gap-2 justify-center">
              <div className="p-2.5 bg-zinc-950 rounded-lg border border-zinc-850 flex items-center justify-between">
                <div className="flex flex-col gap-0.5">
                  <span className="font-semibold text-zinc-200">Règles de répondeur</span>
              ...
              {currentStep >= 2 && (
                <div className="p-2.5 bg-zinc-950/60 rounded-lg border border-zinc-850/50 flex flex-col gap-1.5 animate-fade-in">
                  <span className="text-[7px] uppercase font-semibold text-zinc-500">Destination du renvoi</span>
                  <div className="flex gap-1.5">
                    <span className="px-2 py-1 rounded bg-zinc-800 border border-zinc-750 text-zinc-350 font-semibold">
                      Messagerie vocale
                    </span>

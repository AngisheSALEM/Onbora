  ...
  return (
    <div className="w-full flex items-center justify-between p-3.5 bg-[#0B0B0F] rounded-full shadow-lg">
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-700 text-white font-black text-sm shadow-sm shrink-0">
          {displayName.charAt(0).toUpperCase()}
          <span className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-500 rounded-full ring-2 ring-[#0B0B0F]" />
        </div>
      ...
      <div className="flex items-center gap-2 pr-1">
        <div className="hidden xl:flex flex-col items-end mr-2">
          <span className="text-[10px] uppercase font-bold text-zinc-500">Portefeuille</span>
          <span className="text-xs font-mono font-black text-white">485 k€ MRR</span>
        </div>

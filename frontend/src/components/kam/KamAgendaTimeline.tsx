          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-3.5 px-2 rounded-2xl transition-all duration-200 cursor-pointer ${
                isSelected
                  ? 'bg-white text-black shadow-xl font-semibold scale-[1.02]'
            ...
            >
              ...
              <span className={`text-base md:text-xl font-extrabold font-sans tracking-tight ${isSelected ? 'text-black' : 'text-white'}`}>
                {d.dayNumber}
              </span>
              <span className={`text-[10px] md:text-xs uppercase font-semibold mt-0.5 ${isSelected ? 'text-zinc-700' : 'text-zinc-500'}`}>
                {d.dayName}
              </span>
            </button>
          );
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3 mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs uppercase font-extrabold tracking-wider text-zinc-600">
                ...
                <h2 className="text-xl md:text-2xl font-extrabold text-black tracking-tight leading-tight mt-1">
                  {visit.account_name}
                </h2>
                ...
                <div className="flex flex-wrap items-center gap-3 mt-6 pt-4 border-t border-zinc-100">
                  <button
                    ...
                    className="flex-1 min-w-[160px] flex items-center justify-center gap-2 py-3 px-4 bg-black hover:bg-zinc-800 text-white rounded-2xl text-xs font-extrabold transition-all active:scale-95 shadow-md cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-3 px-4 bg-zinc-100 hover:bg-zinc-200 text-zinc-900 rounded-2xl text-xs font-semibold transition-all active:scale-95 cursor-pointer"
                  >
                    <Icons.Users size={15} />
                    <span>MEDDIC</span>
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-3 px-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-xs font-extrabold transition-all active:scale-95 shadow-md cursor-pointer"
                  >
                    <Icons.Mic size={15} />
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm md:text-base font-semibold text-white group-hover:text-blue-400 transition-colors line-clamp-1">
                      {visit.account_name}
                    </h3>
                ...
                <div className="flex items-center gap-1.5 text-xs font-mono font-semibold text-zinc-400 bg-[#16161D] px-2.5 py-1 rounded-full shrink-0">
                  <Icons.Clock size={12} />
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#16161D] text-[11px] text-zinc-500">
                ...
                <span className="font-semibold text-zinc-400 shrink-0 ml-2">
                  {visit.status_label}
                </span>
              </div>
            </div>

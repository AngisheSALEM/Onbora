...
<body>
    <div class="no-print no-print-bar">
        ...
        <button onclick="window.print()" class="print-btn">Imprimer / PDF</button>
    </div>

    <div class="header">
        <div class="header-logo">
            <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="100" height="100" rx="24" fill="#007AFF" />
...
def generate_reportlab_pdf_response(doc_type, obj):
    ...
    # -------------------------------------------------------------
        ...
        story.append(Paragraph("• <b>Email de support</b> : support@onbora.cg", body_style))

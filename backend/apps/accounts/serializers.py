...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'role', 'phone', 'company_name', 'first_name', 'last_name', 'location', 'is_available', 'kam_specialization', 'avatar', 'profile_picture_url']
        read_only_fields = ['id']
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['username', 'email', 'password', 'role', 'phone', 'company_name', 'first_name', 'last_name', 'avatar', 'profile_picture_url']

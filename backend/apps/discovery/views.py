...
def _build_twin_export_html(conversation, dossier, twin) -> str:
    """Helper to assemble the Target Architecture Diagnostic HTML export."""
...
class ConversationExportView(APIView):
    ...
    def get(self, request, pk):
        ...
        content_html = _build_twin_export_html(conversation, dossier, twin)
